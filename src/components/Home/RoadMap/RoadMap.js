  ...
  return (
    <div className='container mx-auto section__padding'>
      <div className='flex flex-col text-center justify-center items-center lg:px-8 my-10'>
        <h2>Roadmap</h2>
        <p className='my-8 p__style'>The roadmap illustrates what we're working on. We are continuously updating <br className='hidden lg:block'/> it based on your feedback.</p>
      </div>
      ...
      <div>
        <div className="road_map_main_section">
          ...
          <div className="road_map_data_box road_map_single_data_box_three">
            ...
            <div className="road_map_single_data_box_three_date"><h5>2023 Q5</h5></div>
